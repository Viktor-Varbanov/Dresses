...
namespace DressWebsiteTests.Pages.PurchaseSummary
{
    public partial class PurchaseSummary
    {
        ...
        //Product Information
        public IWebElement ProductSectionHeaderText =>
        ...
        public IWebElement ProductImageUrl =>
             Driver.FindElement(By.ClassName("layer_cart_img img-responsive"));
        ...
        public IWebElement ProductsTotalCost => Driver.FindElement(By.ClassName("ajax_block_products_total"));
